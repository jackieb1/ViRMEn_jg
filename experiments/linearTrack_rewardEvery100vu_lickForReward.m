function code = linearTrack_rewardEvery100vu_lickForReward
...
function vr = initializationCodeFun(vr)
    ...
    vr.rewardDistance = 99;
    vr.rewardZoneRadius = 10;
    vr.probAutomaticReward = 0.2;
...
function vr = runtimeCodeFun(vr)
    ...
    if (abs(vr.position(2)-(vr.lastRewardLocation + vr.rewardDistance)) < vr.rewardZoneRadius) && (vr.isAutomaticReward || vr.isLick)
