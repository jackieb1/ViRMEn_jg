function code = linearTrack200vu_2cues_popup_unrewB300_rewCue2B300
...
%     vr = wrapLinearWorld(vr, 2, 1);
    ...
    vr.isRewardTrial = 0;
    vr.rewardedBlock = 0;
    vr.unrewardedBlockLength = 300;
    vr.rewardBlockLength = 300;
    ...
    vr.currentWorld = 1;
    vr.worldProbability = [0 0.5 0.5]; %[0.2 0.4 0.4];
    vr.cueHasAppeared = 0;
    vr.numInBlock = 0;
