function code = T_maze_headingDriftPulseY150_photostimY150OnHeadingPulseTrials
...
if isTrialStart(vr)
    ...
    if (vr.numTrials > vr.accuracyEvalWindow+vr.accuracyEvalGracePeriod)
    ...
    vr.optoWasOn = 0;
    vr.isStimTrial = vr.isHeadingPulseTrial;
end
