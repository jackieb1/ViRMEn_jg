function code = wideLinearTrack_friction05_towerShift_photostimEndTrial
...
%     vr = wrapLinearWorlds(vr);
    ...
    vr.teleportYLocation = vr.rewardYLocation + 15;
    vr.startYLocation = 2;
...
function vr = runtimeCodeFun(vr)
    ...
    if vr.position(2) > vr.teleportYLocation
        ...
        if mod(vr.numTrials, vr.blockSize) == 0
    ...
    if (vr.distToRewardZone < vr.photostimZoneRadius)
        vr.optoOn = 1;
    else
        vr.optoOn = 0;
    end
