function code = linearTrack_4cues_lickForReward_switchRandom33pct
...
%     vr = wrapLinearWorld(vr, 2, 1);
    ...
    vr.landmarkSwitchProbability = 1/3;
    vr.currentWorld = 1;
...
function vr = runtimeCodeFun(vr)
    ...
    if vr.position(2) > vr.mazeLength
        ...
        if rand <= vr.landmarkSwitchProbability
            vr.currentWorld = 2;
            disp('Switch Landmarks');
        else
            vr.currentWorld = 1;
        end
        vr.cueHasAppeared = 0;
