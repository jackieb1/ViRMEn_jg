function code = T_maze_optoFullTrialPreRamp50pct
...
vr.worldProbability = [1/4 1/4 1/4 1/4];
vr.nextTrialIsStimEligible = 0;
vr.stimTrialEligibleProbability = 0.5;
...
if isTrialStart(vr)
    ...
    vr.nextTrialIsStimEligible = (rand <= vr.stimTrialEligibleProbability);
...
if vr.inITI
    ...
    if (vr.itiTime > (vr.itiDur - vr.optoRamp_s)) && vr.nextTrialIsStimEligible
        if vr.optoOn
