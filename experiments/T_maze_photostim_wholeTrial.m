function code = T_maze_photostim_wholeTrial
...
vr.isStimTrial = 0;
vr.stimOn = 0;
vr.maxStimOnTime_s = 150;
vr.correctControlTrials = [];
vr.minControlBlockSize = 2;
vr.stimBlockSize = 2;
vr.accuracyThreshold = 0.85;
...
if isTrialStart(vr)
    ...
    vr = evaluateStimBlock(vr);
    vr = evaluateStimTrial(vr);
...
vr = collectBehaviorIter_TMaze(vr, vr.stimOn);
