function code = linearTrack_randomCue_rewardAfter50Trials
...
function vr = runtimeCodeFun(vr)
    ...
    if (vr.currentWorld == 2) && (vr.position(2) > vr.rewardLocation) && vr.isRewardTrial && (vr.numTrials >= vr.firstRewardTrial)
