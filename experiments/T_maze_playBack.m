...
% Collect data in behavData
% vr.sessionData(1:vr.numColumns, vr.iterNumber) = vr.behavData(:, vr.iterNumber);
% vr.sessionData(vr.numColumns+1, vr.iterNumber) = vr.dt;
